...
export default function JuegoMemoria() {
  ...
  const { categoriaId, nivelId, cantidad = 6 } = location.state || {
  ...
  useEffect(() => {
    ...
    const loadWords = async () => {
      ...
      try {
        const res = await getPalabrasPublic({ categoriaId, nivelId, limit: 50 });
      ...
      <div className="max-w-4xl mx-auto">
          ...
          <div className="flex justify-center gap-8 mb-8">
            <div className="text-center">
              <p className="text-base sm:text-lg text-[var(--text-dark)] opacity-60 mb-1">
                Intentos
              </p>
                      ...
                      >
                        {card.isMatched ? (
                          <div className="flex flex-col items-center justify-center gap-1">
                            ...
                            <span className="font-extrabold text-[var(--text-dark)] text-base sm:text-lg leading-tight text-center px-1">
                              {card.content}
                            </span>
                          </div>
                        ) : (
                          <>
                            <div className="flex-1 w-full flex items-center justify-center min-h-0">
                              {isVideoCard ? (
                                ...
                                <span className="font-extrabold text-[var(--text-dark)] text-base sm:text-lg leading-tight block px-1 text-center">
                                  {card.content}
                                </span>
                              )}
                            </div>
