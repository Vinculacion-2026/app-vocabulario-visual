    ...
    >
      <section aria-label="Buscar y filtrar palabras" className="mb-6 sm:mb-8">
        ...
        <div className="grid sm:grid-cols-2 gap-3 sm:gap-4">
          <div>
            <label htmlFor="filtro-categoria" className="block text-base sm:text-lg font-bold text-[var(--text-dark)] mb-2">
              Categoría
            </label>
            <Select
          ...
          <div>
            <label htmlFor="filtro-nivel" className="block text-base sm:text-lg font-bold text-[var(--text-dark)] mb-2">
              Nivel
              ...
              <li key={palabra.id}>
                ...
                >
                  ...
                  <div className="p-3 sm:p-4 text-center">
                    <h2 className="font-bold text-[var(--text-dark)] mb-1 text-base sm:text-lg">
                      {palabra.palabra}
                    </h2>
                    {palabra.nivelNombre && (
                      <span
