...
export default function JuegoUnir() {
  ...
  const { categoriaId, nivelId, cantidad = 5 } = location.state || {
  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-center text-[var(--text-muted)] mb-6 sm:mb-8 text-base sm:text-lg">
                  ...
                  <div className="flex items-center gap-3 p-3">
                    ...
                    <div className="flex-1 text-left">
                      {connected ? (
                        ...
                        <p className="text-base sm:text-lg font-bold text-[var(--green-primary)]">
                          ✅ Ahora elige la palabra
                        </p>
                      ) : (
                        <p className="text-base sm:text-lg text-[var(--text-muted)]">Toca para seleccionar esta seña</p>
                      )}
                    </div>
                  </div>
                </motion.button>
