    ...
    return (
      ...
      >
        ...
        <div className="p-4 sm:p-5 sm:pr-6 flex-1">
          <h3 className="text-xl sm:text-2xl font-bold text-[var(--text-dark)] mb-1">{juego.nombre}</h3>
          <p className="text-base sm:text-lg text-[var(--text-muted)]">{juego.desc}</p>
        </div>
      </motion.button>
    );
  }
  ...
  return (
    ...
    >
      ...
      <div className="p-3 sm:p-4">
        <h2 className="font-extrabold text-[var(--text-dark)] text-base sm:text-lg mb-0.5">{juego.nombre}</h2>
        <p className="text-sm sm:text-base text-[var(--text-muted)] leading-snug">{juego.desc}</p>
      </div>
    </motion.button>
  );
}
