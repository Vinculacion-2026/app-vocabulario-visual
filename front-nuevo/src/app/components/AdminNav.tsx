...
export function AdminBrand() {
  return (
    <Link to="/admin" className="block mb-6 lg:mb-8 pt-1 no-underline text-white hover:opacity-90 transition-opacity">
      <h1 className="text-xl sm:text-2xl font-bold flex items-center gap-2 m-0">
        <span aria-hidden="true">🤟</span>
        <span>Señas App</span>
      </h1>
      <p className="text-sm opacity-75 mt-1 m-0">Panel del profesor</p>
    </Link>
  );
}
